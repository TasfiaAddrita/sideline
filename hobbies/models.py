...
class Hobby(models.Model):
    ...
    name = models.CharField(
        max_length=settings.HOBBY_PAGE_NAME_MAX_LENGTH, unique=True,
        help_text="Name of your hobby.")

    # replace CharField with ForeignKey
    # business = models.CharField(
    #     help_text="What business does this hobby belong to? (May be deleted in future versions when a business model is created)")

    slug = models.CharField(
        max_length=settings.HOBBY_PAGE_NAME_MAX_LENGTH, blank=True, editable=False,
...
class Hobbies(models.Model):
    """Represents a single hobby."""
    name = models.CharField(max_length=settings.HOBBY_PAGE_NAME_MAX_LENGTH, unique=True,
                            help_text="Name of your hobby.")
    slug = models.CharField(max_length=settings.HOBBY_PAGE_NAME_MAX_LENGTH, blank=True, editable=False,
                            help_text="Unique URL path to access this page. Generated by the system.")
    ...
    modified = models.DateTimeField(auto_now=True,
                                    help_text="The date and time this page was updated. Automatically generated when the model updates.")
    # scheduled_date = models.DateTimeField(default="Scheduled date")
...
class Attend(models.Model):
    ...
    choice = models.CharField(max_length=200, default='Attending')
